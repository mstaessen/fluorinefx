...
namespace FluorineFx
{
	...
	/// </summary>
	sealed class ASExceptionObject : ASObject
	{
		/// <summary>
		/// Initializes a new instance of the ExceptionASO class.
		/// </summary>
        /// <param name="exception">The exception that is the cause of the current exception.</param>
		public ASExceptionObject(Exception exception)
		{
			...
			if(exception.InnerException != null)
				Add("rootcause", new ASExceptionObject(exception.InnerException));
		}

        public ASExceptionObject(string error)
        {
            Add("code", "Server.Processing");
            Add("level", "error");
