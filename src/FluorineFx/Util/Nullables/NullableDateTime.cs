...
namespace FluorineFx.Util.Nullables
{
    public class NullableDateTimeConverter : TypeConverter
    {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            if (value is string)
            {
                ...
                var newValue = (DateTime)converter.ConvertFromString(context, culture, stringValue);
                                         ...
                                         Type destinationType)
        {
            ...
            {
                var nullable = (NullableDateTime)value;

                var constructorArgTypes = new Type[1] { typeof(DateTime) };
                var constructor = typeof(NullableDateTime).GetConstructor(constructorArgTypes);

                if (constructor != null)
                {
                    var constructorArgValues = new object[1] { nullable.Value };
                    return new InstanceDescriptor(constructor, constructorArgValues);
                }
            }
            else if (destinationType == typeof(DateTime))
            {
                var ndt = (NullableDateTime)value;
    ...
    public struct NullableDateTime : INullableType, IFormattable, IComparable
    {
        ...
        public int CompareTo(object obj)
        {
            ...
            {
                var value = (NullableDateTime)obj;
