...
namespace FluorineFx.Util
{
    ...
    public class Convert
    {
        ...
        public static Byte[] ToByteArray(string value) { return value == null ? null : Encoding.UTF8.GetBytes(value); }
        /// <summary>
        ...
        public static Byte[] ToByteArray(Stream value)
        {
            ...
            var position = value.Seek(0, SeekOrigin.Begin);
...
#if !NET_1_1 && !NET_2_0
            if (value is XDocument) return ToXmlDocument((XDocument)value);
            if (value is XElement) return ToXmlDocument((XElement)value);
#endif
