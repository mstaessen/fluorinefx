...
namespace FluorineFx.Util
{
    ...
    public abstract class ReflectionUtils
	{
        ...
        public static bool ItemsUnitializedValue<T>(IList<T> list)
        {
            ...
            var elementType = GetListItemType(list.GetType());
		...
		public static MemberInfo GetMember(Type type, string name, MemberTypes memberTypes, BindingFlags bindingAttr)
		{
			...
			var result = type.GetMember(name, memberTypes, bindingAttr);
		...
		{
			var attributes = GetAttributes(type, attributeProvider, inherit);
		...
		public static MemberInfo[] FindMembers(Type targetType, MemberTypes memberType, BindingFlags bindingAttr, MemberFilter filter, object filterCriteria)
		{
            ...
            var memberInfos = new List<MemberInfo>(targetType.FindMembers(memberType, bindingAttr, filter, filterCriteria));
		...
		public static object CreateGeneric(Type genericTypeDefinition, IList innerTypes, params object[] args)
		{
			...
			var specificType = MakeGenericType(genericTypeDefinition, CollectionUtils.CreateArray(typeof(Type), innerTypes) as Type[]);
        ...
        {
            return types.Any(type => type.IsByRef);
        }
	}
    ...
    public static class ReflectionExtensions
    {
        ...
        {
            var attrib = type.GetCustomAttributes(attributeType, inherit);
            ...
            throw new AmbiguousMatchException("Ambiguous Custom Attribute");
        }
    }
}
